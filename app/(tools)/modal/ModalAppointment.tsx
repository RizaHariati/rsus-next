...
const ModalAppointment = (props: Props) => {
  ...
  return (
    <div className="modal-xl p-5 px-10 overflow-hidden bg-white">
      ...
      <div>
        {consultationInfo.intro.map((item: string) => {
          return <p className="body-2">{item}</p>;
        })}
      </div>
      <div className="w-full  grid grid-cols-3 gap-5 h-full body-3 max-h-96 custom-scrollbar">
