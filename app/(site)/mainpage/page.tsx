...
const MainPage = (props: Props) => {
  return (
    <div className=" page-main-container ">
      ...
      <section
        id="zero"
        className="h-full md:min-h-screen w-full z-0 overflow-hidden flex flex-col md:flex-row relative snap-start md:snap-center bg-white md:bg-accent1 pb-2 border-b border-greyBorder"
      >
        <MainImageSmall />
